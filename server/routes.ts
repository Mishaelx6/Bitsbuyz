  ...
  app.put('/api/site-content', isAdmin, async (req, res) => {
    try {
      const validatedContent = insertSiteContentSchema.parse({
        siteName: req.body.siteName || "BitsBuyz - Digital Learning Platform",
        logoText: req.body.logoText || "BitsBuyz",
        navHome: req.body.navHome || "Home",
        navBooks: req.body.navBooks || "Digital Books",
        navVideos: req.body.navVideos || "Videos",
        navAdmin: req.body.navAdmin || "Admin",
        booksPageTitle: req.body.booksPageTitle || "Digital Book Library",
        booksPageSubtitle: req.body.booksPageSubtitle || "Explore our complete collection of digital books and educational content.",
        videosPageTitle: req.body.videosPageTitle || "Video Library",
        videosPageSubtitle: req.body.videosPageSubtitle || "Watch educational videos and entertainment content.",
        footerDescription: req.body.footerDescription || "BitsBuyz is a Nigerian based e-commerce startup delivering seamless digital learning experiences with premium quality content accessible 24/7.",
        footerCopyright: req.body.footerCopyright || "© 2024 BitsBuyz. All rights reserved.",
        footerLinks: req.body.footerLinks || "Privacy Policy | Terms of Service",
        contactTitle: req.body.contactTitle || "Get In Touch",
        contactSubtitle: req.body.contactSubtitle || "Contact us for any inquiries about our digital learning platform.",
        contactButtonText: req.body.contactButtonText || "Send Message",
        whatIDoTitle: req.body.whatIDoTitle || "What We Do",
        whatIDoSubtitle: req.body.whatIDoSubtitle || "We provide seamless digital learning experiences with digital books, videos, and premium quality content accessible 24/7.",
